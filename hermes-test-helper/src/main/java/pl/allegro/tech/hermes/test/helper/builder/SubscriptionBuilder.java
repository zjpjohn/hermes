...
public class SubscriptionBuilder {
    ...
    public Subscription build() {
        if (deliveryType == DeliveryType.SERIAL) {
            return Subscription.createSerialSubscription(
                    ...
                    filters, mode, headers, metadata, subscriptionOAuthPolicy
            );
        } else {
            return Subscription.createBatchSubscription(
                    ...
                    trackingEnabled, supportTeam, contact, monitoringDetails, contentType,
                    filters, headers, metadata, subscriptionOAuthPolicy
            );
        }
    }
    ...
    public SubscriptionBuilder withSubscriptionOAuthPolicy(SubscriptionOAuthPolicy subscriptionOAuthPolicy) {
